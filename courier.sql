...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 23, 2024 at 11:12 AM
...
--
ALTER TABLE `thread`
  ADD CONSTRAINT `thread_ibfk_1` FOREIGN KEY (`followBy_id`) REFERENCES `user` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `thread_ibfk_2` FOREIGN KEY (`thread_type_id`) REFERENCES `thread_type` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
